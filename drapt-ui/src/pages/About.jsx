    ...
    return (
        <div className="p-2 flex flex-col gap-3 mx-auto max-w-5xl">
            <div className="p-2">
                ...
                <nav className='text-sm text-primary space-y-1 pl-2 text-base-content mt-1'>
                    <a href="#whatisdrapt" className='block before:content-["-"] before:mr-2 before:text-base-content text-sm hover:text-base-content'>
                        <span className="underline">What is Drapt?</span>
                    </a>
                    <a href="#beginnings" className='block before:content-["-"] before:mr-2 before:text-base-content text-sm hover:text-base-content'>
                        <span className="underline">An early vision</span>
                    </a>
                    <a href="#milestone1" className='block before:content-["-"] before:mr-2 before:text-base-content text-sm hover:text-base-content'>
                        <span className="underline">Milestone #1</span>
                    </a>
                    <a href="#milestone2" className='block before:content-["-"] before:mr-2 before:text-base-content text-sm hover:text-base-content'>
                        <span className="underline">Milestone #2</span>
                    </a>
                    <a href="#current" className='block before:content-["-"] before:mr-2 before:text-base-content text-sm hover:text-base-content'>
                        <span className="underline">Where Drapt currently stands</span>
                    </a>
                    <a href="#acknowledgments" className='block before:content-["-"] before:mr-2 before:text-base-content text-sm hover:text-base-content'>
                        <span className="underline">Acknowledgments</span>
                    </a>
                </nav>
            </div>
            <div className='divider my-1'></div>
            <div id="whatisdrapt" className="card card-border border-primary bg-base-100 shadow-md hover:shadow-lg transition-shadow">
                <div className="card-body">
                    <div className='flex justify-between'>
                        <h2 className="card-title text-2xl">What is Drapt?</h2>
                        <span className="badge badge-s badge-primary text-white">Drapt</span>
                    </div>
            ...
            <div className='divider my-1'></div>
            <div id="beginnings" className="card bg-primary text-white shadow-md hover:shadow-lg transition-shadow">
                <div className="card-body">
                    <div className='flex justify-between'>
                        <h2 className="card-title text-2xl">Early vision...</h2>
                        <span className="badge badge-s badge-base">November, 2024</span>
                    </div>
            ...
            <div id="milestone1" className="card card-border border-primary bg-base-100 shadow-md hover:shadow-lg transition-shadow">
                <div className="card-body">
                    <div className='flex justify-between'>
                        <h2 className="card-title text-2xl">Milestone #1</h2>
                        <span className="badge badge-s badge-primary text-white">End of November, 2024</span>
                    </div>
                    ...
                    <figure className='flex flex-col items-center my-2'>
                        <img src={iteration1} alt="Screenshot of the first functional DRAP-T prototype, November 2024" className='w-full sm:w-2/3 md:w-1/2 rounded' />
                        <figcaption className='text-xs italic text-gray-500 mt-1 text-center'>
                    ...
                    <ul className='list-none pl-2 space-y-1 text-base'>
                        ...
                        <li className="before:content-['-'] before:mr-2 before:text-gray-500 text-sm">A cumulative portfolio returns plot, which was done incorrectly, using <code className="bg-gray-100 text-blue-500 px-1 rounded text-sm font-mono">cumsum()</code> instead of <code className="bg-gray-100 text-blue-500 px-1 rounded text-sm font-mono">cumprod()</code> - I'll admit, I didn't use log returns initially...</li>
            ...
            <div id="milestone2" className="card bg-primary text-white shadow-md hover:shadow-lg transition-shadow">
                <div className="card-body">
                    <div className='flex justify-between'>
                        <h2 className="card-title text-2xl">Milestone #2</h2>
                        <span className="badge badge-s badge-base">February, 2025</span>
                    </div>
                    ...
                    <div className='flex flex-col md:flex-row justify-center items-center gap-4'>
                        <figure className='flex flex-col items-center w-full sm:w-3/4 md:w-1/2 lg:w-2/5'>
                            <img src={milestone21} alt="Rolling Volatility chart screenshot from Milestone 2" className='w-full rounded border-2 border-white' />
                            <figcaption className='text-xs italic text-gray-200 mt-1 text-center'>
            Figure 2: Rolling Volatility
        </figcaption>
                        </figure>
                        <figure className='flex flex-col items-center w-full sm:w-3/4 md:w-1/2 lg:w-2/5'>
                            <img src={milestone22} alt="Asset correlation matrix screenshot from Milestone 2" className='w-full rounded border-1 border-white' />
                            <figcaption className='text-xs italic text-gray-200 mt-1 text-center'>
        ...
        Team Notts for Profit, representing NEFSIF on the 17th floor of The Shard (Feb, 2025)
            ...
            <div id="current" className="card card-border border-primary bg-base-100 shadow-md hover:shadow-lg transition-shadow">
                <div className="card-body">
                    <div className='flex justify-between'>
                        <h2 className="card-title text-2xl">Where it currently stands</h2>
                        <span className="badge badge-s badge-primary text-white">Present</span>
                    </div>
                    ...
                    <p>Welcome aboard, this journey will be an exciting one.</p>
                    <div className="w-full flex justify-start">
                        <img src={signature} alt="Szymon Kopyciński signature" className="h-16" />
                    </div>
                    <p>Szymon</p>
                </div>
            </div>
            <div id="acknowledgments" className="card bg-primary text-white shadow-md hover:shadow-lg transition-shadow">
                <div className="card-body">
                    <h2 className="card-title text-2xl">Acknowledgments</h2>
