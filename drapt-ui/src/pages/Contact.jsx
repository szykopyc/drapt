    ...
    return (
        <MainBlock>
            <BeginText title={"Contact"}>
                <p>
                    Feel free to get in touch with the NEFS Investment Fund, or
                    Szymon.
                </p>
            </BeginText>
            ...
            <CardOne id="nefsif-contact" title="Contact NEFSIF" badge="Fund">
                <div className="flex flex-col md:flex-row gap-4 items-start">
                    ...
                    />
                    <ContactProfileCardElement
                        name={"NEFS Investment Fund"}
                        introText={
                            "Contact the Fund for all enquiries. The team will normally answer within business hours, Monday to Friday, 09:00 until 17:00."
                        }
                    >
                        <div className="flex items-center gap-2">
                            ...
                            <a
                                tabIndex={0}
                                href="mailto:nefsinvestmentfund@gmail.com"
                                className="hover:underline text-info"
                            >
                                nefsinvestmentfund@gmail.com
                            </a>
                        </div>
                        <div className="flex items-center gap-2">
                            ...
                            <a
                                tabIndex={0}
                                href="https://www.instagram.com/nefsif/"
                                target="_blank"
            ...
            <CardOne id="szymon-contact" title="Contact Szymon" badge="Direct">
                <div className="flex flex-col md:flex-row gap-4 items-start">
                    ...
                    <ContactProfileCardElement
                        ...
                        optionalRole={
                            "Founder and Developer, Head of Systems and Publications"
                        }
                        introText={
                            "Contact me for both technical and fund enquiries. I will respond to messages where possible."
                        }
                    >
                        <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <a
                                tabIndex={0}
                                href="mailto:szymon.kopycinski@outlook.com"
                                className="hover:underline text-info"
                            >
                                szymon.kopycinski@outlook.com
                            </a>
                        </div>
                        <div className="flex items-center gap-2">
                            ...
                            <a
                                tabIndex={0}
                                href="https://linkedin.com/in/szymonkopycinski"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="hover:underline text-info"
                            >
