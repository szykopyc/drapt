...
import { FaPhoneAlt, FaLinkedin, FaEnvelope, FaWhatsapp } from 'react-icons/fa';
...
export default function Contact() {
    return (
        <div className="p-2 flex flex-col gap-3 mx-auto max-w-5xl">
            ...
            <div id="szymon-contact" className='card card-border border-primary bg-base-100 shadow-md hover:shadow-lg transition-shadow'>
                <div className='card-body'>
                    <h2 className='card-title text-2xl'>Contact Szymon</h2>
            ...
            <div id="nefsif-contact" className='card card-border border-primary bg-base-100 shadow-md hover:shadow-lg transition-shadow'>
                <div className='card-body'>
                    <h2 className='card-title text-2xl'>Contact NEFS Investment Fund</h2>
                </div>
            </div>
        </div>
    );
