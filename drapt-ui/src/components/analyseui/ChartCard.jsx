...
export default function ChartCard({
  ...
  return (
    <div
      className={`card ${isExpanded ? "" : "card-border border-primary"
        } bg-base-100 ${isExpanded ? "" : "shadow-md hover:shadow-lg transition-shadow"
        } ${sizeClasses[size]}`}
      style={{
    ...
    >
      ...
      >
        <div className="flex items-center justify-between">
          <h2
            className={`card-title text-2xl ${!content ? "mb-4" : ""
              }`}
          >
            {title}
          </h2>
