            ...
            >
                ...
                >
                    <FormField
                        ...
                        error={errors.current && errors.current.message}
                    >
                        <input
                            type="password"
                    ...
                    <FormField
                        label="New Password"
                        error={errors.next && errors.next.message}
                    >
                        <input
                            type="password"
                            className="input input-bordered w-full"
                    ...
                    >
                        <input
                            ...
                            {...register("confirm", {
                                ...
                                validate: (value) =>
                                    value === next || "Passwords do not match",
                            })}
                            autoComplete="new-password"
                        />
                    </FormField>
                    ...
                    <div className="flex flex-row gap-2 mt-2 w-full">
                        <button
                            type="submit"
                            className="btn btn-primary self-end shadow-md hover:shadow-lg transition-shadow text-primary-content"
