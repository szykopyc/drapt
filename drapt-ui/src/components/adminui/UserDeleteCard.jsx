...
export function UserDeleteCard() {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      queryClient.invalidateQueries({ queryKey: ["user", targetUser.role] });
  ...
  return (
    <>
      ...
      >
        ...
        has been deleted. This action is irreversible. Changes may take a few minutes to reflect in the system.
      </ModalHelper>
    </>
  );
}
