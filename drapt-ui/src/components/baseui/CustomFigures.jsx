...
export function FigureCap({srcfile, alt, cursorPointerEnabled=false, children, invert=false, ...props}){ 
    ...
    return (
        <figure className='flex flex-col items-center my-2' {...props}>
            ...
            <figcaption className={`text-xs italic ${textClass} mt-1 text-center`}>
                {children}
            </figcaption>
        </figure>        
    );
...
export function SmallerFigureCap({srcfile, alt, cursorPointerEnabled=false, children, invert=false, ...props}){
    const textClass = invert 
        ? "text-white-500"
        : "text-base-content/50"
...
export function FullscreenFigureCap({srcfile, alt, children, ...props}){
    return (
        <figure className="flex flex-col items-center my-2" {...props}>
            ...
            <figcaption className={`text-lg italic text-base-content/50 mt-1 text-center`}>
                {children}
            </figcaption>
        </figure>
    );
